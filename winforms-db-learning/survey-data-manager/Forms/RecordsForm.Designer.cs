namespace MyWinFormsAppForDb
{
	partial class RecordsForm
	{
		...
		private void InitializeComponent()
		{
			...
			// btn_d
			// 
			btn_d.Font = new Font("Tahoma", 12F, FontStyle.Regular, GraphicsUnit.Point);
			btn_d.Location = new Point(1011, 325);
			btn_d.Margin = new Padding(3, 2, 3, 2);
			btn_d.Name = "btn_d";
			btn_d.Size = new Size(85, 38);
			btn_d.TabIndex = 13;
			btn_d.Text = "Delete";
			...
			btn_cancel.Location = new Point(1011, 367);
			btn_cancel.Margin = new Padding(3, 2, 3, 2);
			btn_cancel.Name = "btn_cancel";
			btn_cancel.Size = new Size(85, 38);
			btn_cancel.TabIndex = 22;
			btn_cancel.Text = "Cancel";
			btn_cancel.UseVisualStyleBackColor = true;
			btn_cancel.Click += rtn_cancel_Click;
			// 
			// btn_search
			// 
		...
		private void Personalization()
		{
			switch (_identity.GetRole())
			{
				...
				case "scientist":
					_tableNames = AvailableTables.Scientist;
					break;

				// Actions for operator role
				case "operator":
					_tableNames = AvailableTables.Operator;
					break;
				...
				case "analyst":
					...
					dgv.ReadOnly = true;
					_tableNames = AvailableTables.Analyst;
					break;

				// Default case
				default:
					_tableNames = AvailableTables.Admin;
					break;
			}
		}
